...
async def get_score():
    ...
    o_ratio = 0.5 - r_ratio
    input_json = {"bcr": bcr, "tier": 3, "residential": r_ratio, "office": o_ratio, "amenity": 0.2, "civic": 0.3}
    ...
    total = aesthetic_index+affordability_index+tax_revenue_index+profit_index+environment_index
    scores = [aesthetic_index, affordability_index, tax_revenue_index, profit_index, sky_view_index, surface_to_volume_index]
