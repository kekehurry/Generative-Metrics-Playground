...
# def affordable_housing_cost():
#     ## we assume the affordable housing cost increase with the resident space increase
#     ## the value between 0-100
#     affordable_housing_cost = 0.1 * backend.input_data.resident_space
#     return affordable_housing_cost
...
def compute_government():
    ...
    score_gov = {
        ...
        'distance': get_government_distance() * 4
        }
